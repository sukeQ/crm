...
const DetailTableBackyard = ({
  ...
  const resulttelldata = telldata && telldata[0];
  const resulttuwadata = tuwadata && tuwadata[0];
  const resultkakuyakutelldata = kakuyakutelldata && kakuyakutelldata[0];
  const resultpldata = pldata && pldata[0];
            ...
            <div className="bg-white border-2 border-gray-300 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  <Tablebody resultdata={resulttelldata} title={title11} />
                  <Tablebody resultdata={resulttuwadata} title={title12} />
                  <Tablebody
                    resultdata={resultkakuyakutelldata}
                    title={title13}
                  />
                  <Tablebody resultdata={resultpldata} title={title14} />
                </tbody>
              </table>
            </div>
          </div>
...
export default DetailTableBackyard;
