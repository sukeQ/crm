      ...
      return (
        ...
        >
          <td className="h-px w-px text-xs whitespace-nowrap">
            <Link href={`/components/approachcheck/details/ap`}>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result4_ly != 0 && data.result4 != 0
                ? Math.floor((data.result4 / data.result4_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result5_ly != 0 && data.result5 != 0
                ? Math.floor((data.result5 / data.result5_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result6_ly != 0
                ? Math.floor((data.result6 / data.result6_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result7_ly != 0
                ? Math.floor((data.result7 / data.result7_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result8_ly != 0
                ? Math.floor((data.result8 / data.result8_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result9_ly != 0
                ? Math.floor((data.result9 / data.result9_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result10_ly != 0
                ? Math.floor((data.result10 / data.result10_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result11_ly != 0 && data.result11 != 0
                ? Math.floor((data.result11 / data.result11_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result12_ly != 0 && data.result12 != 0
                ? Math.floor((data.result12 / data.result12_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result1_ly != 0 && data.result1 != 0
                ? Math.floor((data.result1 / data.result1_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result2_ly != 0 && data.result2 != 0
                ? Math.floor((data.result2 / data.result2_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.result3_ly != 0 && data.result3 != 0
                ? Math.floor((data.result3 / data.result3_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.resultq1_ly != 0
                ? Math.floor((data.resultq1 / data.resultq1_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.resultq2_ly != 0
                ? Math.floor((data.resultq2 / data.resultq2_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.resultq2_ly != 0
                ? Math.floor((data.resultq3 / data.resultq3_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            >
              {data.resultq4_ly != 0 && data.resultq4 != 0
                ? Math.floor((data.resultq4 / data.resultq4_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
          ...
          <td className={td_style2}>
            ...
            <span
              className={
                Math.floor((data.resulthy1 / data.resulthy1_ly) * 100) / 100 >=
                1
                  ? "block p-0.5 text-xs text-blue-400"
                  : "block p-0.5 text-xs text-red-400"
              }
            >
              {data.resulthy1_ly != 0 || data.resulthy1 != 0
                ? Math.floor(
                    (data.resulthy1 / data.resulthy1_ly) * 100
                  ).toFixed(0) + "%"
                : "-"}
            </span>
          </td>
          ...
          <td className={td_style2}>
            ...
            <span
              className={
                Math.floor((data.resulthy2 / data.resulthy2_ly) * 100) / 100 >=
                1
                  ? "block p-0.5 text-xs text-blue-400"
                  : "block p-0.5 text-xs text-red-400"
              }
            >
              {data.resulthy2_ly != 0 && data.resulthy2 != 0
                ? Math.floor(
                    (data.resulthy2 / data.resulthy2_ly) * 100
                  ).toFixed(0) + "%"
                : "-"}
            </span>
          </td>
          ...
          <td className={td_style2}>
            ...
            >
              {data.resultty_ly != 0 && data.resultty != 0
                ? Math.floor((data.resultty / data.resultty_ly) * 100).toFixed(
                    0
                  ) + "%"
                : "-"}
            </span>
